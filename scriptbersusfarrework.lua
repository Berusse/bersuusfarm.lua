wait(0.5)
local MenuPanel = game.CoreGui:FindFirstChild("BERUS SCRIPT")
...
TextLabel.BackgroundColor3 = Color3.fromRGB(186, 85, 211) -- Violet clair
TextLabel.BorderSizePixel = 0
TextLabel.Position = UDim2.new(0.5, -350, 0.4, -130)
TextLabel.Size = UDim2.new(0, 410, 0, 30)
TextLabel.Font = Enum.Font.SourceSans
TextLabel.Text = "BERUS SCRIPT                               V1                  "
TextLabel.TextColor3 = Color3.fromRGB(153, 102, 204)
...
MenuPanel.BackgroundColor3 = Color3.fromRGB(72, 61, 139) -- Violet foncé
...
MinimizeButton.BackgroundColor3 = Color3.fromRGB(123, 104, 238) -- Violet moyen
...
bottomLine.BackgroundColor3 = Color3.fromRGB(75, 0, 130) -- Indigo
...
meleeLabel.Text = "TRANSFORMATION:  "
...
local missions = {
    { name = "Kid Nohag", bossName = "Kid Nohag", requiredValue = 0, endRange = 8000000 },
    { name = "SSJB Wukong", bossName = "SSJB Wukong", requiredValue = 8000001, endRange = 50000000 },
    { name = "Winter Wukong", bossName = "Winter Wukong", requiredValue = 50000001, endRange = 150000000 },
    { name = "SSJG Kakata", bossName = "SSJG Kakata", requiredValue = 150000001, endRange = 2000000000 },
    { name = "Vekuta (LBSSJ4)", bossName = "Vekuta (LBSSJ4)", requiredValue = 2000000001, endRange = 5000000000 },
    { name = "Wukong Rose", bossName = "Wukong Rose", requiredValue = 5000000001, endRange = 5500000000 },
    { name = "Vekuta (SSJBUI)", bossName = "Vekuta (SSJBUI)", requiredValue = 5500000001, endRange = 7000000000 },
    { name = "Winter Bills", bossName = "Winter Bills", requiredValue = 7000000001, endRange = math.huge },
}
...
local function startMission()
    ...
    -- Spammer la transformation
    while true do
        transform()
        task.wait() -- Ajoute un petit délai pour éviter un crash du jeu
    end
end
...
task.spawn(function()
    while true do
        ...
        local success, fallo = pcall(function()
            ...
            if data.Strength.Value < 2000000000 and game.PlaceId ~= 3311165597 and isLoop1Active then
                local A_1 = "Earth"
                ...
                task.wait(8)  -- Attendre 8 secondes avant de réévaluer
            -- Si la puissance est supérieure ou égale à 2 milliards, téléporter vers Vills Planet
            elseif data.Strength.Value >= 2000000000 and game.PlaceId ~= 5151400895 and isLoop1Active then
    ...
    while true do
        ...
        task.spawn(function()
            ...
            if boss and boss:FindFirstChild("Humanoid") and boss.Humanoid.Health > 0 then
                ...
                -- Récupérer l'orientation de l'ennemi et se positionner derrière
                local enemyHRP = boss.HumanoidRootPart
                local behindPosition = enemyHRP.CFrame * CFrame.new(0, 0, 5) -- 4 unités derrière lui
